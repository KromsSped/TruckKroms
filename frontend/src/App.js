...
function Dashboard({ token, setToken }) {
  ...
  const ajouter = async () => {
    ...
    formData.append("chauffeurRend", chauffeurRend);
    formData.append("chauffeurRecoit", chauffeurRecoit);
    formData.append("pneus", pneus);
    formData.append("carburant", carburant);
    formData.append("outils", outils);
    formData.append("remorque", remorque);
    formData.append("materiel", materiel);
    formData.append("incident", incident);
    formData.append("datePrise", datePrise);
    formData.append("dateRestitution", dateRestitution);
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <input placeholder="Carburant" value={carburant} onChange={e => setCarburant(e.target.value)} />
      <input placeholder="Outils" value={outils} onChange={e => setOutils(e.target.value)} />
      ...
      <input placeholder="Incident" value={incident} onChange={e => setIncident(e.target.value)} />
